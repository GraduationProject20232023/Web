                ...
                <div className="home-primary-nav-container">
                    ...
                    <div className="home-nav-right">
                        <div className="home-search-container">
                            <input className="home-search-input" placeholder="검색" type="text"></input>
                        ...
                        <div className="home-member-container">
                                <div className="home-member-login" onClick={()=>{setLoginBool(true)}}>로그인</div>
                                <a href="/">회원가입</a>
                        </div>
                    </div>
                </div>

                <div className="home-sub-nav-container">
                    <ul className="home-sub-nav-list">
                        <a href="/">{subNav[0]}</a>
                        <a href="/">{subNav[1]}</a>
                        <a href="/">{subNav[2]}</a>
                    </ul>
